...
export default {
  ...
  computed: {
    ...
    storeFN () {
      return this.$store.state[`process-analysis`].pdiDdrParams;
    },
  },
  watch: {
    // 监听筛选条件数据的变化
  ...
  methods: {
    ...
    async fetch () {
      ...
      if (echartsData.length) {
        ...
        // 渲染series
        console.log('serLength', this.echartsListList[0]);
