...
// 车辆档案
export const vehicleFaultRecordColumns = [vin, cartypeName, batchCode, type, standardFaultLevel, customFaultLevel, startTime, endTime, faultCode, faultName, vcuSpareparts, mcupareparts];
