...
export default {
  ...
  methods: {
    ...mapActions(['getOrderExportData', 'getPartCodeData', 'getPartNameData', 'getSupplierCodeData', 'getSupplierNameData']),
    /**
     * 查询
     */
    orderSearch () {
      ...
      const claimOrderFormSearch = { ...this.claimOrderFormRecord };
