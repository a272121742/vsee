...
<Meta title="组件库|Form表单/NetMultipleTreeSelect网络下拉单选树（新）" />

# 网络下拉单选树

注意： 原有的`NetMultipleTreeSelect`已经废弃，当前为最新版本，其完全按照原有思路设计，但是做了内部的很多调整，从API到组件内的逻辑等。并且已经适配了`Ant-Design-Vue`中的`FormModel`组件。
