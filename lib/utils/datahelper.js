...
import {
  tryCatch, always, forEachObjIndexed, map, forEach, pipe, indexBy, prop, omit, ifElse, identity, pick, merge, objOf, curry, converge, compose
} from 'ramda';
 ...
 */
const attr = curry((obj, propPath) => path(propPath.split('.'), obj))
